...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxPFJets__phf = 9;
   static const Int_t kMaxPFJets__elf = 9;
   ...
   static const Int_t kMaxPFJetsCHS__phf = 7;
   static const Int_t kMaxPFJetsCHS__elf = 7;
   ...
   static const Int_t kMaxFatJets_ = 1;
   static const Int_t kMaxFatJets__genR = 1;
   static const Int_t kMaxFatJets__cor = 1;
   static const Int_t kMaxFatJets__jecLabels = 1;
   static const Int_t kMaxFatJets__unc = 1;
   static const Int_t kMaxFatJets__uncSrc = 1;
   static const Int_t kMaxFatJets__area = 1;
   static const Int_t kMaxFatJets__looseID = 1;
   static const Int_t kMaxFatJets__tightID = 1;
 ...
 //QCDEvent        *events;
   ...
   Float_t         PFJetsCHS__phf_[kMaxPFJetsCHS_];   //[PFJetsCHS__]
   Float_t         PFJetsCHS__elf_[kMaxPFJetsCHS_];   //[PFJetsCHS__]
   ...
   vector<double>  FatJets__jecLabels_[kMaxFatJets_];
   ...
   TBranch        *b_PFJetsCHS__phf_;   //!
   TBranch        *b_PFJetsCHS__elf_;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      std::string filename = "Pythia8-CUETM1-Flat-HighStatistics-MagnetOff.root";
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(filename);
      if (!f || !f->IsOpen()) {
         f = new TFile(filename);
      }
      TDirectory * dir = (TDirectory*)f->Get(filename + ":/ak4");
...
void LocalOpenDataTreeProducer::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("PFJetsCHS_.phf_", PFJetsCHS__phf_, &b_PFJetsCHS__phf_);
   fChain->SetBranchAddress("PFJetsCHS_.elf_", PFJetsCHS__elf_, &b_PFJetsCHS__elf_);
   ...
   fChain->SetBranchAddress("FatJets_.jecLabels_", &FatJets__jecLabels_, &b_FatJets__jecLabels_);
