...
if __name__ == '__main__':
    for sample in samples: 
        ...
        #os.system('python baconBatch.py cmsRun params0.npy -a 1:OpenDataTreeProducerOptimized_dataPAT_2011_cfg.py  --list 2:%s.txt --outdir %s --eosoutdir root://cmseos.fnal.gov//eos/uscms/store/user/woodson/DSHEP2017/%s -q 1nh -n 8000'%(sample,sample,sample))
        os.system('python baconBatch.py cmsRun params0.npy -a 1:OpenDataTreeProducerOptimized_dataPAT_2011_cfg.py  --list 2:%s.txt --outdir %s --eosoutdir root://cmseos.fnal.gov//eos/uscms/store/user/woodson/DSHEP2017/%s -q 1nh -n 8000 --monitor resub'%(sample,sample,sample))
